...
const CITY_LANDMARKS: Record<string, Record<string, GeoPoint>> = {
  ...
  丽江: {
    ...
    丽江古城: { lng: 100.234, lat: 26.872 },
    古城: { lng: 100.234, lat: 26.872 },
    四方街: { lng: 100.234, lat: 26.872 },
    木府: { lng: 100.233, lat: 26.87 },
    狮子山万古楼: { lng: 100.23, lat: 26.869 },
    万古楼: { lng: 100.23, lat: 26.869 },
    狮子山: { lng: 100.23, lat: 26.869 },
    束河古镇: { lng: 100.204, lat: 26.917 },
    玉龙雪山: { lng: 100.258, lat: 27.098 },
    蓝月谷: { lng: 100.245, lat: 27.058 },
    冰川公园: { lng: 100.262, lat: 27.118 },
  },
  平潭: {
  ...
  福州: {
    三坊七巷: { lng: 119.301, lat: 26.082 },
    鼓山: { lng: 119.389, lat: 26.038 },
    西湖公园: { lng: 119.286, lat: 26.099 },
    福建博物院: { lng: 119.273, lat: 26.145 },
  },
  武夷山: {
    天游峰: { lng: 117.991, lat: 27.635 },
    武夷宫: { lng: 117.978, lat: 27.652 },
    九曲溪: { lng: 117.968, lat: 27.641 },
  },
  黄山: {
    迎客松: { lng: 118.169, lat: 30.139 },
    光明顶: { lng: 118.164, lat: 30.132 },
    宏村: { lng: 117.998, lat: 30.004 },
    西递古村落: { lng: 117.988, lat: 29.905 },
  },
  泰山: {
    岱庙: { lng: 117.135, lat: 36.192 },
    红门: { lng: 117.125, lat: 36.215 },
    玉皇顶: { lng: 117.112, lat: 36.254 },
  },
  峨眉山: {
    报国寺: { lng: 103.485, lat: 29.552 },
    金顶: { lng: 103.337, lat: 29.523 },
    万年寺: { lng: 103.345, lat: 29.567 },
  },
  乐山: {
    乐山大佛: { lng: 103.772, lat: 29.544 },
    乌尤寺: { lng: 103.768, lat: 29.541 },
  },
  九寨沟: {
    九寨沟风景区: { lng: 103.918, lat: 33.262 },
    五花海: { lng: 103.885, lat: 33.162 },
    诺日朗瀑布: { lng: 103.912, lat: 33.178 },
    长海: { lng: 103.895, lat: 33.055 },
  },
  贵阳: {
    甲秀楼: { lng: 106.714, lat: 26.574 },
    黔灵山公园: { lng: 106.688, lat: 26.601 },
    青岩古镇: { lng: 106.676, lat: 26.338 },
  },
  拉萨: {
    布达拉宫: { lng: 91.118, lat: 29.655 },
    大昭寺: { lng: 91.132, lat: 29.652 },
    八廓街: { lng: 91.131, lat: 29.651 },
  },
  洛阳: {
    龙门石窟: { lng: 112.477, lat: 34.558 },
    白马寺: { lng: 112.605, lat: 34.722 },
    丽景门: { lng: 112.471, lat: 34.680 },
  },
  扬州: {
    瘦西湖: { lng: 119.421, lat: 32.408 },
    个园: { lng: 119.446, lat: 32.402 },
    东关街: { lng: 119.455, lat: 32.397 },
  },
  无锡: {
    鼋头渚: { lng: 120.228, lat: 31.515 },
    灵山大佛: { lng: 120.098, lat: 31.431 },
    惠山古镇: { lng: 120.278, lat: 31.587 },
  },
  宁波: {
    天一阁博物院: { lng: 121.539, lat: 29.871 },
    老外滩: { lng: 121.559, lat: 29.878 },
    东钱湖: { lng: 121.662, lat: 29.793 },
  },
  绍兴: {
    鲁迅故里: { lng: 120.582, lat: 29.992 },
    沈园: { lng: 120.579, lat: 29.988 },
    兰亭景区: { lng: 120.498, lat: 29.923 },
  },
  乌镇: {
    乌镇西栅景区: { lng: 120.485, lat: 30.748 },
    乌镇东栅景区: { lng: 120.498, lat: 30.741 },
  },
  舟山: {
    普陀山: { lng: 122.385, lat: 29.977 },
    普济寺: { lng: 122.387, lat: 29.978 },
    朱家尖南沙景区: { lng: 122.394, lat: 29.877 },
  },
  威海: {
    刘公岛: { lng: 122.183, lat: 37.501 },
    成山头风景区: { lng: 122.691, lat: 37.389 },
  },
  济南: {
    趵突泉: { lng: 117.015, lat: 36.661 },
    大明湖: { lng: 117.027, lat: 36.672 },
    千佛山: { lng: 117.036, lat: 36.632 },
  },
  长白山: {
    长白山北坡: { lng: 128.062, lat: 42.042 },
    天池: { lng: 128.056, lat: 42.005 },
  },
  青海湖: {
    青海湖二郎剑景区: { lng: 100.548, lat: 36.601 },
    茶卡盐湖: { lng: 99.078, lat: 36.791 },
    塔尔寺: { lng: 101.568, lat: 36.487 },
  },
  张掖: {
    张掖七彩丹霞旅游景区: { lng: 100.113, lat: 38.959 },
    大佛寺: { lng: 100.458, lat: 38.931 },
  },
  华山: {
    华山游客中心: { lng: 110.092, lat: 34.561 },
    西峰: { lng: 110.082, lat: 34.482 },
    北峰: { lng: 110.089, lat: 34.498 },
  },
  武当山: {
    金顶: { lng: 111.004, lat: 32.401 },
    太子坡: { lng: 111.015, lat: 32.418 },
    紫霄宫: { lng: 111.002, lat: 32.425 },
  },
  恩施: {
    恩施大峡谷: { lng: 109.198, lat: 30.456 },
    恩施土司城: { lng: 109.479, lat: 30.283 },
  },
  宜昌: {
    三峡大坝: { lng: 111.003, lat: 30.823 },
    三峡人家: { lng: 111.156, lat: 30.791 },
  },
  婺源: {
    篁岭: { lng: 117.978, lat: 29.328 },
    江湾景区: { lng: 118.004, lat: 29.369 },
    李坑: { lng: 117.993, lat: 29.347 },
  },
  景德镇: {
    古窑民俗博览区: { lng: 117.184, lat: 29.291 },
    陶溪川文创街区: { lng: 117.218, lat: 29.301 },
  },
  庐山: {
    牯岭镇: { lng: 115.992, lat: 29.574 },
    含鄱口: { lng: 116.018, lat: 29.548 },
    三叠泉: { lng: 116.008, lat: 29.519 },
  },
  西双版纳: {
    野象谷: { lng: 101.019, lat: 22.143 },
    中国科学院西双版纳热带植物园: { lng: 101.254, lat: 21.932 },
    告庄西双景: { lng: 100.803, lat: 22.010 },
  },
  腾冲: {
    热海景区: { lng: 98.441, lat: 24.948 },
    和顺古镇: { lng: 98.485, lat: 25.018 },
  },
  香格里拉: {
    独克宗古城: { lng: 99.708, lat: 27.825 },
    普达措国家公园: { lng: 99.951, lat: 27.839 },
    松赞林寺: { lng: 99.703, lat: 27.868 },
  },
  北海: {
    北海银滩: { lng: 109.292, lat: 21.449 },
    涠洲岛: { lng: 109.105, lat: 21.042 },
  },
  潮州: {
    牌坊街: { lng: 116.652, lat: 23.661 },
    开元寺: { lng: 116.656, lat: 23.664 },
    广济桥: { lng: 116.661, lat: 23.661 },
  },
  珠海: {
    珠海渔女: { lng: 113.588, lat: 22.261 },
    珠海长隆海洋王国: { lng: 113.538, lat: 22.099 },
  },
  泉州: {
    开元寺: { lng: 118.585, lat: 24.917 },
    西街: { lng: 118.584, lat: 24.916 },
    清源山: { lng: 118.614, lat: 24.949 },
  },
  三亚: {
